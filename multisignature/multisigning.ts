...
async function multisigning(): Promise<void> {
    ...
    /**
     * creating a new wallet on the testnet and funding it with XRP from the testnet's faucet. The result is an object containing the new wallet's information, including the account's address and secret key.
     */
